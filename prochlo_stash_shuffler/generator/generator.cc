...
int main(int argc, char* argv[]) {
  ...
  printf(
      ...
      "Starting file generation. Don't forget to save the Shuffler private\n"
      "key along with the generated file, if you hope to shuffle the file\n"
      "later!!!.\n"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n");

  // For count of prochlomations, generate shuffler item and write it to the
  // file.
  if (!prochlo.GenerateRandomShufflerItems()) {
    warn("generate_random_shuffler_items failed.");
    return -1;
  }
