...
int SGX_CDECL main(int argc, char* argv[]) {
  ...
  printf(
      "Shuffling with data size=%lu, crowd ID size=%lu, ShufflerItem "
  ...
  sgx_status_t result = ecall_shuffle(
      global_eid, (void*)encrypted_items, number_of_items, number_of_buckets,
      chunk_size, stash_size, stash_chunks, clean_up_window,
      (void*)decrypted_items, (void*)encrypted_intermediate_items,
      number_of_intermediate_items);
  if (result != SGX_SUCCESS) {
    printf("ecall_shuffle failed with error code (%i)\n", result);
